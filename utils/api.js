...
// Type property for question is a setting prepared for future use,
  ...
  CommonSense: {
    ...
    questions: [
      ...
      },
      {
        ...
        type: 'judgement',
        answer: false,
        explaination: 'When during the night we’re lying on our bed, our spine is not affected by the pressure of the body weight, and consequently the intervertebral discs relax and stretch.'
      },
      {
        id: 'CommonSense3',
        ...
        type: 'judgement',
        answer: true,
        explaination: 'Nope. In the southern hemisphere, the Sun (as well as the Moon and the stars) still rises in the East and sets in the West. This is because the "movement" of the Sun in the sky is caused by the Earth\'s rotation, and the northern and southern hemispheres are obviously rotating in the same direction.'
      }
    ]
  },
  Programming: {
    ...
    questions: [
      {
        ...
        type: 'judgement',
        answer: true,
        explaination: 'Yes. That\'s the feature of stack. Queue is first in first out.'
      },
      {
        id: 'Programming2',
        ...
        type: 'judgement',
        answer: false,
        explaination: 'No. In JS, empty object is not null. Even for partial equal ==, empty object is also not null.'
      },
      {
        id: 'Programming3',
        ...
        type: 'judgement',
        answer: false,
        explaination: 'No. ES6 makes this more straightforward. Try to write a function seperately with traditional ES5 way and then ES6 fat arrow =>. Check the differences.'
      }
    ]
  }
}
